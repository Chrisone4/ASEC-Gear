...
def main():
    ...
    print("""
  ######################################
  # ASEC_GEAR Development Environment Setup #
  ######################################

  This script will create your ASEC_GEAR dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your ASEC_GEAR project folder:
    [Arma 3 installation directory]\\{} => ASEC_GEAR project folder
    P:\\{}                              => ASEC_GEAR project folder
